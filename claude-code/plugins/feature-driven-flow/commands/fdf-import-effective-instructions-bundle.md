---
description: FDF — import compiled/effective instructions from a directory bundle
...
3. Expected bundle layout:
   ...
   - `phases/scope.md`, `phases/explore.md`, `phases/clarify.md`, `phases/architect.md`, `phases/implement.md`, `phases/verify.md`, `phases/summarize.md`

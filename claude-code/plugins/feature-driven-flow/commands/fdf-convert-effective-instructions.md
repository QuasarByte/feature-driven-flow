---
description: FDF — convert effective-instructions artifacts between directory bundle and compact formats
...
4. Use conversion tool: `fdf/scripts/convert-effective-instructions.ps1`
5. Preserve `custom_instructions` block during conversion when present.
6. Validate resulting artifact against target schema in `fdf/schemas/`.
